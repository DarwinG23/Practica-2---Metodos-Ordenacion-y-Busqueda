...
from controls.tda.linked.linealBinary import LinealBinary
from controls.tda.linked.binary import Binary
...
class Linked_List(object):
    ...
    # def buscar(self, data, atribute = None, busqueda = 1):
    #     if self.isEmpty:
    #         raise LinkedEmpty("List is Empty")
    #     else:
    #         ListNew = Linked_List()
    ...
    #             if busqueda == 1:
    #                 search = LinealBinary()
    #                 ListNew = search.lineal_binary_search_number(self, data)
    #             else:
    #                 search = Binary()
    #                 ListNew = search.binary_search_number(self, data)
    #         else:
    #             if busqueda == 1:
    #                 search = LinealBinary()
    #                 ListNew = search.lineal_binary_search_models(self, data, atribute)
    #             else:
    #                 search = Binary()
    #                 ListNew = search.binary_search_models(self, data, atribute)
    #         return ListNew
